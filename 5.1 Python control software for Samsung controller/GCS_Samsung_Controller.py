...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Rescaling_gain_spnbox_lb = QLabel("Stiffness [Nm/deg]")    
        Flex_Assist_spnbox_lb    = QLabel("Damping [Nm/deg/s]")    
        Ext_Assist_spnbox_lb     = QLabel("Feedforward Force [Nm]")    
        Assist_delay_spnbox_lb   = QLabel("Assistive Ratio")      
